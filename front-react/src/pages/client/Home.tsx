    ...
    const carregar = async () => {
      try {
        ...
        if (Array.isArray(propostas)) {
          // Só mostra propostas PENDENTE para enviar
    ...
    <>
      ...
      <div className="user-header">
        ...
        <div className="user-actions">
          ...
          <button className="icon-btn" title="Sair" onClick={async () => { await logout(); navigate('/login'); }}><i className="fas fa-sign-out-alt" /></button>
        </div>
      </div>

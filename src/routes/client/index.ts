...
router.put('/proposals/:id', authenticateToken, ProposalClientController.atualizar)
router.delete('/proposals/:id', authenticateToken, ProposalClientController.deletar)
